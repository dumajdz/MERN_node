...
const OrderPage = () => {
  ...
  //Gui danh sach den redux store
  useEffect(() => {
    dispatch(selectedOrder({listChecked}))
  },[listChecked])
  //cap nhat gia tri cho form
  useEffect(() => {
    form.setFieldsValue(stateUserDetails)
  }, [form, stateUserDetails])
  
  useEffect(() => {//cap nhat stateuserdetail khi mo modal
  ...
  //tinh toan gia tri giam gia, phi ship, tong gia tri don hang
        ...
        <Form
          ...
          >
            ...
            <Form.Item
              label="T.Phố"
              name="city"
              rules={[{ required: true, message: 'Chưa điền thành phố!' }]}
            >
            ...
            <Form.Item
              label="Sdt"
              name="phone"
              rules={[{ required: true, message: 'Chưa điền sdt!' }]}
            >
